...
PTS32 _getHandRecognitizeGestureUp(Mat& handImg, double stdKnockBaseArea, const RoiLocation roiLocation, PTHandStatus& handStatus)
{
#ifdef _SHOW_
    gHandID++;
#endif
...
PTS32 _getHandRecognitizeGestureDown(Mat& handImg, double stdKnockBaseArea, const RoiLocation roiLocation, PTHandStatus& handStatus)
{
#ifdef _SHOW_
    gHandID++;
#endif
