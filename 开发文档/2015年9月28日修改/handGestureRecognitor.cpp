...
{
    _getHandRecognitizeGestureUp(gUpHandImg, this->mStdUpPointArea, ROIUP, handStatus);
    return PT_RET_OK;
}
...
PTS32 HandGestureRecognitor::getDownHandGesture(PTHandStatus& handStatus)
{
    ...
    _getHandRecognitizeGestureDown(gDownHandImg, this->mStdDownPointArea, ROIDOWN, handStatus);
    return PT_RET_OK;
}
